...
Dim 2_byte_cmd As Byte : 2_byte_cmd = &H4D
Dim 3_byte_cmd As Byte : 3_byte_cmd = &H00
Dim 4_byte_cmd As Byte : 4_byte_cmd = &H00                  '4th byte command (mosi)
Dim 5_byte_cmd As Byte : 5_byte_cmd = &H01                  '5th byte command (mosi)
