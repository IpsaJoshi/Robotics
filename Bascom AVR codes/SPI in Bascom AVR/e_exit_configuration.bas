...
Dim 2_byte_cmd As Byte : 2_byte_cmd = &H43
Dim 3_byte_cmd As Byte : 3_byte_cmd = &H00
Dim 4_byte_cmd As Byte : 4_byte_cmd = &H01                  '4th byte command (mosi)
Dim 5_byte_cmd As Byte : 5_byte_cmd = &H5A                  '5th byte command (mosi)
Dim 6_byte_cmd As Byte : 6_byte_cmd = &H5A
Dim 7_byte_cmd As Byte : 7_byte_cmd = &H5A
Dim 8_byte_cmd As Byte : 8_byte_cmd = &H5A
Dim 9_byte_cmd As Byte : 9_byte_cmd = &H5A


Dim 1_byte_data As Byte : 1_byte_data = &HFF
Dim 2_byte_data As Byte : 2_byte_data = &H41
Dim 3_byte_data As Byte : 3_byte_data = &H5A
Dim 4_byte_data As Byte : 4_byte_data = &HFF                '4th byte data  (miso)
Dim 5_byte_data As Byte : 5_byte_data = &HFF                '5th byte data (miso)
